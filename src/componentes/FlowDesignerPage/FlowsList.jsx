    ...
    <Box sx={{ height: "100%", backgroundColor: colors.background[500] }}>
      {isDesigning ? (
        ...
        >
          ...
          >
            <Typography variant="h3">DIAGRAMAS</Typography>
            <Button
              sx={{
          ...
          {flowsList.length > 0 ? (
            ...
            >
              <Table>
                ...
                <TableHead>
                  <TableRow>
                    {["ID", "Nombre", "Canal", "Autor", "Activo", ""].map(
                      (header) => (
                        <TableCell
                          key={header}
                          sx={{
                      ...
                      sx={{
                        ...
                        backgroundColor:
                          index % 2 === 0
                            ...
                            : colors.background[300], // Alternar colores
                        "&:hover": {
                        ...
                        <Button
                          ...
                          sx={{
                            ...
                            color: flow.activo
                              ? colors.accentGreen[100]
                              : colors.accentRed[100],
                            borderColor: flow.activo
                              ? colors.accentGreen[100]
                              : colors.accentRed[100],
                            "&:hover": {
                              color: flow.activo
                                ? colors.accentGreen[400]
                                : colors.accentRed[400],
                              borderColor: flow.activo
                                ? colors.accentGreen[400]
                                : colors.accentRed[400],
                              background: flow.activo
                          ...
                          onClick={() =>
                            dispatch(toggleFlowActiveThunk(flow.id))
                          }
                        >
                          {flow.activo ? (
                            <DoneOutlinedIcon />
            ...
            >
              <Typography variant="h3">No hay flows disponibles.</Typography>
            </Box>
          )}
        </Box>
      )}
